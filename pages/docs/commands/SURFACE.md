...
\* Construct the vector![](../Image255.gif)"10" height="15",
from q to p.

\* Construct the outward normal to the
triangle, ![](../Image256.gif)"9" height="12". The outward
...
\* If ![](../Image255.gif)"10"
height="15"\* ![](../Image256.gif)"9" height="12"&lt; 0 then
the point is inside. If ![](../Image255.gif)"10"
height="15"\* ![](../Image256.gif)"9" height="12"&gt;0 the
point is outside. If ![](../Image255.gif)"10"
height="15"![](../Image256.gif)"9" height="12"\* n = 0, and if
p is on the triangle then p=q and p in on the triangle.

\* If ![](../Image255.gif)"10"
height="15"\*![](../Image256.gif)"9" height="12" = 0 and p is
not on the triangle then p is outside.

![](../new_html/Image257.gif)"203" height="206"
...
![](../new_html/Image259.gif)"341" height="248"
